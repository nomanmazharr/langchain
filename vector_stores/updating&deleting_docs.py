...
updated_document1 = Document(
    page_content="""Babar Azam is a technically gifted right-handed batter known for his elegance and consistency at the crease. As captain, he anchors Pakistan's batting lineup with calm authority and class.""",
    metadata={"team": "Peshawar Zalmi"}
)

# vector_store.update_document(document=updated_document1, document_id='d8690881-f778-437d-808a-43542cac07e9')

# print(vector_store.get(include=['embeddings','documents', 'metadatas']))

vector_store.delete(ids='d8690881-f778-437d-808a-43542cac07e9')
print(vector_store.get(include=['embeddings','documents', 'metadatas']))